...
---------------------------------------------------------------------------------------------------------------------------
-- 9. Load data into the tables using copy into statements. In one table loadfrom the internal stage and in another from            the external.
---------------------------------------------------------------------------------------------------------------------------
truncate table my_table;

copy into assignment_db.my_schema.my_table
from (select t.$1,t.$2,t.$3,t.$4,t.$5,t.$6,t.$7,t.$8,t.$9, current_timestamp, metadata$filename, 'local' 
from @assignment_db.my_schema.my_stage t)
...
CREATE TABLE assignment_db.my_schema.loading_from_external
(
    index int,
    user_id string,
    first_name string,
...
copy into assignment_db.my_schema.loading_from_external
from (select t.$1,t.$2,t.$3,t.$4,t.$5,t.$6,t.$7,t.$8,t.$9, current_timestamp, metadata$filename, 'AWS S3' 
from @assignment_db.my_schema.s3_stage t)
file_format = assignment_db.my_schema.my_csv_format
on_error = 'skip_file';

select * from loading_from_external limit 10;
